...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         <option value="" disabled selected>Danh Mục Đặc Sản --</option>
         <option value="Miền Nam">Đặc Sản Miền Nam</option>
         <option value="Miền Bắc">Đặc Sản Miền Bắc</option>
         <option value="Miền Trung">Đặc Sản Miền Trung</option>
         <option value="Miền Tây">Đặc Sản Miền Tây</option>
      </select>
...
<section class="show-products" style="padding-top: 0;">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Bạn có muốn xóa sản phẩm không?');">Xóa</a>
      </div>
   </div>
   <?php
         }
